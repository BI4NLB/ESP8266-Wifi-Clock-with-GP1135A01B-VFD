...
#define NTP_ADDRESS  "time1.aliyun.com"  // change this to whatever pool is closest (see ntp.org)ca.pool.ntp.org
...
const char* ssid = "godlike";   // insert your own ssid 
const char* password = "126shanliuyuanzhang";              // and password
String date;
String t;
...
void loop() 
{
  ...
  {   
    ...
    TimeChangeRule usEDT = {"EDT", Second, Sun, Mar, 2, 480};  //UTC - 5 hours - change this as needed
    TimeChangeRule usEST = {"EST", First, Sun, Nov, 2, 480};   //UTC - 6 hours - change this as needed
